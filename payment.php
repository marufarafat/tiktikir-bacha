					...
					<div class="col-xl-8 offset-xl-4">
						<form class="contact-form" >
						   ...
						   <div class="col-12 col-md-7">
								...
								<div class="col-12 col-md-7">
                                    <div class="form-group">
                                        <input type="text" maxlength="16" placeholder="Card Number" required>
                                    </div>
                                </div>
								<div class="col-12 col-md-7">
                                    <div class="form-group">
										<input type="text" maxlength="3" placeholder="CVC" required>
                                    </div>
                                </div>
								<div class="col-12 col-md-7">
                                    <div class="form-group">
                                        <input type="text" placeholder="Expiry Date  MM/YYYY" required>
                                    </div>
                                </div>

								<div class="col-xl-8 offset-xl-2">
									<br><br><br>
								     <button type="button" name="payment" onclick="window.location.href='/halo/payment.php'" class="site-btn light">Donate</button>
