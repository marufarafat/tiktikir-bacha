	...
	<header class="header-section sp-pad">
		...
		<nav class="main-menu">
			<ul>
				...
				<li class=active><a href="about.php">About Plastic</a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by INVISIBLE</a>
