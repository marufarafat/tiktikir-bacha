          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Plastic Pollution Audio Zone</h3>
              </div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="vedio_upload.php" method="POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Audio Title</label>
					  ...
					  <div class="form-group">
							...
							<div class="col-md-6 col-sm-12">
								<select class="select2_single form-control" tabindex="-1" name="category">
									...
									<option value="Tree">Pollution Audio</option>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Audio</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <input type="link" class="form-control" name="audio">
                          <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
                      </div>								
